            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form method="post" action="../config/edit.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?=$item['id_motor']?>">
                        <label for="motor" class="fw-bold">Nama motor</label>
                        <input type="text" id="motor" class="form-control mb-3" name="motor" value="<?=$item['nama_motor']?>">
                        <label for="pemilik" class="fw-bold">Nama Pemilik</label>
                        <input type="text" id="pemilik" class="form-control mb-3" name="pemilik" value="<?=$item['pemilik_motor']?>">
                        <label for="merk" class="fw-bold">Merk</label>
                        <input type="text" id="merk" class="form-control mb-3" name="merk" value="<?=$item['merk_motor']?>">
                        ...
                        <input type="file" id="foto" class="form-control mb-3" name="foto" value="<?=$item['foto_motor']?>">
                        <div class="mb-3">
