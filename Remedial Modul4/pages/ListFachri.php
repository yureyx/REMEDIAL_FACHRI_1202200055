        ...
        <div class="container py-5">
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="../assets/images/<?=$item['foto_motor']?>" class="img-thumbnail">
                            <h4 class="mt-3"><?=$item['merk_motor'].' '.$item['nama_motor']?></h4>
                            <div class="mb-4"><?=$item['deskripsi']?></div>
                            <a href="../pages/DetailFachri.php?id=<?=$item['id_motor']?>" class="btn btn-primary px-5 rounded-pill">Detail</a>
                            <a href="../config/delete.php?id=<?=$item['id_motor']?>" class="btn btn-danger px-5 rounded-pill">Delete</a>
                        </div>
                    </div>
                </div>
                <?php }?>
            </div>
            <p class="fw-bold">Jumlah motor: <?=$count_row?></p>
        </div>
